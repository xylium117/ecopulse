...
def test_alerts_endpoint_global():
    ...
    # Check that Nepal ongoing flood alert is present in planetary alert stream
...
def test_ocean_exclusion_zero_risk():
    ...
    # Inference over ocean returns 0 ha affected
    ocean_infer_params = {
        "preset": "viewport",
        "lon_min": -145.0,
        "lat_min": -2.0,
...
def test_distinct_severity_levels():
    # Test Nepal preset returns Critical
    ...
    # Test India preset returns High
    ...
    # Test Bangladesh preset returns Medium
    ...
    # Test ocean scan returns None (zero risk)
