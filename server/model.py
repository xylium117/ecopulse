...
class WildfireSegmenter :
    ...
    def generate_demo_pair (self ,preset :str ="california")->Tuple [np .ndarray ,np .ndarray ,Dict [str ,Any ]]:
        ...
        if preset =="amazon":
            ...
            post =pre .copy ()
            fire_scar =(((xx -140 )**2 /65 **2 +(yy -110 )**2 /50 **2 )<1 )|(((xx -100 )**2 /40 **2 +(yy -165 )**2 /30 **2 )<1 )
...
class FloodSegmenter :
    ...
    def generate_demo_pair (self ,preset :str ="nepal")->Tuple [np .ndarray ,np .ndarray ,Dict [str ,Any ]]:
        ...
        if preset in ("nepal","nepal_flash_flood","nepal_tibet"):
            ...
            post =pre .copy ()
            flood_pulse =(np .abs (xx -river_curve )<48 )|(((xx -110 )**2 /75 **2 +(yy -140 )**2 /55 **2 )<1 )|(((xx -170 )**2 /55 **2 +(yy -200 )**2 /40 **2 )<1 )
            ...
            post =pre .copy ()
            submerged_basin =(((xx -130 )**2 /58 **2 +(yy -130 )**2 /42 **2 )<1 )|(np .abs (xx -(125 +np .sin (yy /35 )*35 ))<28 )
            ...
            post =pre .copy ()
            rambla =((np .abs (xx -(130 +np .sin (yy /20 )*30 ))<25 )&(yy >50 ))|(((xx -145 )**2 /46 **2 +(yy -180 )**2 /34 **2 )<1 )
            ...
            post =pre .copy ()
            delta_flood =(((xx -128 )**2 /42 **2 +(yy -128 )**2 /32 **2 )<1 )|(np .abs (xx -130 )<14 )
